...
public class AuthService : IAuthService
{
    ...
    private readonly TheInvestigationDbContext _db;
    private readonly IEmailService _emailService;

    public AuthService(
        IUserRepository userRepository,
        IConfiguration configuration,
        TheInvestigationDbContext db,
    ...
    public string GenerateJwtToken(int userId, string email)
    {
        ...
        var issuer = jwtSettings["Issuer"] ?? "TheInvestigationApi";
        var audience = jwtSettings["Audience"] ?? "TheInvestigationClient";
