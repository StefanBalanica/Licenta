...
var BaseDeviceComponent = class _BaseDeviceComponent {
  ...
  callTimer;
  callSeconds = 0;
  constructor(route, deviceService, location2, authService) {
    this.route = route;
  ...
  static \u0275fac = function BaseDeviceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BaseDeviceComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(DeviceService), \u0275\u0275directiveInject(Location), \u0275\u0275directiveInject(AuthService));
  };
...
var IPhoneDeviceComponent = class _IPhoneDeviceComponent extends BaseDeviceComponent {
  ...
  authService;
  constructor(route, deviceService, location2, authService) {
    super(route, deviceService, location2, authService);
    this.route = route;
    this.deviceService = deviceService;
    this.location = location2;
    this.authService = authService;
  ...
  static \u0275fac = function IPhoneDeviceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _IPhoneDeviceComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(DeviceService), \u0275\u0275directiveInject(Location), \u0275\u0275directiveInject(AuthService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IPhoneDeviceComponent, { className: "IPhoneDeviceComponent", filePath: "src\\app\\components\\devices\\iphone\\iphone-device.component.ts", lineNumber: 15 });
})();
...
var AndroidDeviceComponent = class _AndroidDeviceComponent extends BaseDeviceComponent {
  ...
  static \u0275fac = function AndroidDeviceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AndroidDeviceComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(DeviceService), \u0275\u0275directiveInject(Location), \u0275\u0275directiveInject(AuthService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AndroidDeviceComponent, { className: "AndroidDeviceComponent", filePath: "src\\app\\components\\devices\\android\\android-device.component.ts", lineNumber: 15 });
})();
...
var LaptopDeviceComponent = class _LaptopDeviceComponent extends BaseDeviceComponent {
  ...
  static \u0275fac = function LaptopDeviceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LaptopDeviceComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(DeviceService), \u0275\u0275directiveInject(Location), \u0275\u0275directiveInject(AuthService));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LaptopDeviceComponent, { className: "LaptopDeviceComponent", filePath: "src\\app\\components\\devices\\laptop\\laptop-device.component.ts", lineNumber: 16 });
})();
...
//# sourceMappingURL=chunk-P2EGT6X5.js.map
