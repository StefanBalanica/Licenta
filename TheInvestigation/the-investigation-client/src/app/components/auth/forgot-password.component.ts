...
@Component({
  ...
  styles: [`
    ...
    .page{--bg:#fcfaf7;--surface:#fff;--border-md:rgba(0,0,0,0.11);--amber:#d43f33;--navy:#1a1a1a;--ink:#1a1a1a;--ink2:rgba(26,22,16,0.45);--ink3:rgba(26,22,16,0.22);--red:#9b2020;min-height:100vh;background:var(--bg);font-family:'Public Sans',sans-serif;display:flex;align-items:center;justify-content:center;padding:32px 20px;}
